...
## Step 1.1: 技术选型预校验 (Technical Guardrails) [MANDATORY]

> **目的**：针对高风险物理变更，强制 AI 刷新短期记忆，防止违反“项目宪法”。

每当任务涉及以下领域，AI **必须显式声明**已重读并对齐 `contexts.md` 的特定章节：
...
**验证要求**：在 Kickoff 汇报中必须包含：`[Tech Check]: contexts.md#[章节号] 已对齐。`
...
[Kickoff Complete] Level: Lx | ETA: Xh | Branch: feat/xxx | Tech Check: OK | Risks: N identified
