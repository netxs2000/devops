...
| **PMO/管理层** | 效能度量、资源协调 | 查看部门记分卡、DORA 指标、投入产出比 (ROI) |
...
### 5.1 数据库接口
*   系统对外暴露一系列 **SQL Views** (位于 `devops_collector/plugins/gitlab/sql_views/`) 作为标准数据接口，供 BI 工具（Superset/Grafana）直接连接查询。
