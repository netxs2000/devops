...
async def get_mr_summary(project_id: int, service: QualityService = Depends(get_quality_service)):
...
async def get_quality_report(project_id: int, service: QualityService = Depends(get_quality_service)):
    """动态生成质量分析报告。"""
    try:
