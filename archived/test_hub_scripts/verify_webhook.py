...
"""'''
    ...
    project_id = 999
    payload = {'object_kind': 'pipeline', 'object_attributes': {'id': 12345, 'ref': 'main', 'status': 'failed', 'sha': 'a1b2c3d4e5f6g7h8', 'finished_at': '2023-10-27 10:00:00'}, 'project': {'id': project_id, 'name': 'Demo Project'}}
