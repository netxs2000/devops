...
"""'''
    ...
    reg_params = {'email': TEST_EMAIL, 'name': '测试员A', 'company': '测试中心', 'reason': '测试身份映射功能'}
    try:
    ...
    approve_params = {'email': TEST_EMAIL, 'approved': 'true', 'admin_token': ADMIN_TOKEN, 'gitlab_user_id': 99}
    ...
    login_params = {'email': TEST_EMAIL, 'code': 123456}
    ...
    bug_data = {'requester_name': '测试员A', 'requester_email': TEST_EMAIL, 'title': '身份穿透测试缺陷', 'severity': 'S2', 'priority': 'P2', 'province': 'nationwide', 'environment': 'test', 'steps_to_repro': '1. 登录\n2. 点击测试', 'actual_result': '穿透成功', 'expected_result': 'GitLab 显示 ID 为 99'}
    ...
    review_params = {'review_state': 'approved', 'token': token}
