...
def setup_test_data(db: Session):
    ...
    db.flush()
    rd_user = User(global_user_id=9002, full_name='RD Admin', primary_email='test_rd@example.com', department_id='Dept_002', role='maintainer')
    mkt_user = User(global_user_id=9004, full_name='Marketing User', primary_email='test_mkt@example.com', department_id='Dept_004', role='guest')
...
def verify_isolation_logic(user_email: str):
    ...
    try:
        ...
        mock_jira_data = [{'id': 'JIRA-1', 'dept': 'Dept_002', 'summary': 'RD Strategic Task'}, {'id': 'JIRA-2', 'dept': 'Dept_003', 'summary': 'Mobile Bug Fix'}, {'id': 'JIRA-3', 'dept': 'Dept_004', 'summary': 'Marketing Campaign'}]
