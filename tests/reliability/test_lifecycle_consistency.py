...
class TestLifecycleConsistency(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.client.get_project.return_value = {
            "id": 100, "name": "Lifecycle Project",
            "namespace": {"id": 10, "name": "G"},
    ...
    def test_merge_request_update_logic(self):
        ...
        mr_v2.update({
            ...
            "state": "merged",
            "updated_at": "2024-01-02T10:00:00Z", # Newer timestamp
            "merge_commit_sha": "def123"
        })
        
        # NOTE: Worker typically uses 'updated_after' filter.
        # If we use the same sync logic, it should fetch this MR because it's updated.
        ...
        # This assertion IS EXPECTED TO FAIL currently based on my code review.
        # The current worker likely does 'if exists: continue' or doesn't update fields.
