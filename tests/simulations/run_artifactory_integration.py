...
from devops_collector.models import Base, NexusComponent, NexusAsset, JFrogArtifact, JFrogScan, User, IdentityMapping
...
"""'''
    ...
    with open(path, 'r', encoding='utf-8') as f:
        return json.load(f)
MOCK_DATA = {'nx_repos': load_mock_json('nexus_repositories.json'), 'nx_comps': load_mock_json('nexus_components.json'), 'jf_artifacts': load_mock_json('jfrog_artifacts.json'), 'jf_stats': load_mock_json('jfrog_stats.json'), 'jf_xray': load_mock_json('jfrog_xray.json')}
