...
# Aggressively mock ALL non-standard dependencies that might cause circularity or DB issues
mock_modules = [
    'dagster', 'dagster_assets', 'dagster_dbt',
    'devops_collector',
    ...
    'devops_collector.plugins.gitlab.worker',
    'devops_collector.plugins.gitlab.models',
    'devops_collector.plugins.jira',
    'devops_collector.plugins.jira.worker',
    'devops_collector.plugins.sonarqube',
    'devops_collector.plugins.sonarqube.worker',
    'sqlalchemy', 'sqlalchemy.orm', 'sqlalchemy.ext', 'sqlalchemy.ext.hybrid',
