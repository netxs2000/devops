...
shadow_df = run_query("SELECT * FROM fct_shadow_it_discovery")
...
if not shadow_df.empty:
    fig = px.scatter(
        ...
        color="discovery_reason",
        hover_name="project_name",
        title="影子 IT 风险评估图 (气泡大小代表参与人数)",
        labels={"risk_score": "风险评分", "last_activity_days_ago": "最后活跃(天)"}
    )
