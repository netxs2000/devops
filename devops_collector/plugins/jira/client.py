...
class JiraClient(BaseClient):
    ...
    def get_issues(self, jql: str) -> List[Dict[str, Any]]:
        ...
        max_results = 100
        while True:
            params = {'jql': jql, 'startAt': start_at, 'maxResults': max_results, 'expand': ['changelog'], 'fields': ['summary', 'description', 'status', 'priority', 'issuetype', 'assignee', 'reporter', 'creator', 'created', 'updated', 'resolutiondate', 'labels', 'fixVersions', 'timeoriginalestimate', 'timespent', 'timeestimate', 'issuelinks']}
