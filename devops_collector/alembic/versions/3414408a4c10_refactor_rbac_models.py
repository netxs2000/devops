...
down_revision: str | None = "2a026ee8eec0"
...
def upgrade() -> None:
    ...
    if "fct_test_execution_summary" in existing_tables:
        op.drop_table("fct_test_execution_summary")
    if "fct_user_activity_profiles" in existing_tables:
        op.drop_table("fct_user_activity_profiles")
    if "fct_performance_records" in existing_tables:
    ...
    op.alter_column("daily_dev_stats", "user_id", existing_type=sa.UUID(), comment="用户ID", existing_nullable=True)
    op.alter_column("daily_dev_stats", "date", existing_type=sa.DATE(), comment="统计日期", existing_nullable=True)
    op.alter_column(
        "daily_dev_stats",
        "first_commit_time",
    ...
    op.add_column(
        "mdm_business_systems",
        sa.Column("rank", sa.String(length=10), nullable=True, comment="重要性分级 (T0/T1/T2/T3)"),
    )
    op.add_column(
        "mdm_business_systems",
        sa.Column(
            ...
            sa.String(length=50),
            nullable=True,
            comment="架构类型 (Microservices/Monolith/Serverless)",
        ),
    )
    op.add_column(
        "mdm_business_systems",
    ...
    op.add_column(
        ...
        sa.Column(
            ...
            nullable=True,
            comment="资源显示名称快照 (如 backend/payment-service)",
        ),
    )
    op.add_column(
        "mdm_entity_topology",
        sa.Column("env_tag", sa.String(length=20), nullable=True, comment="环境标签 (PROD/UAT/TEST/DEV)"),
    )
    ...
    op.alter_column("mdm_entity_topology", "sync_version", existing_type=sa.INTEGER(), nullable=False)
    ...
    op.add_column(
        "mdm_epic",
        sa.Column("epic_code", sa.String(length=50), nullable=False, comment="史诗唯一编码 (如 EPIC-24Q1-001)"),
    )
    ...
    op.add_column(
        "mdm_epic",
        sa.Column("priority", sa.String(length=20), nullable=True, comment="优先级 (P0-Strategic / P1-High)"),
    )
    ...
    op.add_column(
        ...
        sa.Column(
            ...
            nullable=True,
            comment="投资主题 (如 技术债/新业务/合规/客户体验)",
        ),
    )
    ...
    op.add_column(
        "mdm_epic",
        sa.Column("group_id", sa.String(length=100), nullable=True, comment="所属群组/组织ID (GitLab Group)"),
    )
    op.add_column(
        "mdm_epic",
    ...
    op.add_column(
        "mdm_epic",
        sa.Column("external_id", sa.String(length=50), nullable=True, comment="外部系统ID (如 GitLab Epic IID)"),
    )
    ...
    op.add_column(
        ...
        sa.Column(
            ...
            sa.String(length=20),
            nullable=True,
            comment="状态 (OPEN:处理中 / RESOLVED:已恢复 / CLOSED:已结单 / MONITORING:观察中)",
        ),
    )
    op.add_column(
        "mdm_incidents",
        sa.Column(
            ...
            nullable=True,
            comment="故障发生时间 (用于计算 TTI: Time to Impact)",
        ),
    )
    op.add_column(
        "mdm_incidents",
        sa.Column(
            ...
            sa.DateTime(timezone=True),
            nullable=True,
            comment="故障发现时间 (用于计算 MTTD: Time to Detect)",
        ),
    )
    op.add_column(
        "mdm_incidents",
    ...
    op.add_column(
        ...
        sa.Column(
            ...
            sa.String(length=50),
            nullable=True,
            comment="根因分类 (Code Change/Config Change/Capacity/Infrastructure/Exteanl)",
        ),
    )
    op.add_column(
        "mdm_incidents",
    ...
    op.add_column(
        ...
        sa.Column("env_tag", sa.String(length=20), nullable=True, comment="环境标签 (PROD/Stage/Test)"),
    )
    op.add_column(
        "mdm_systems_registry",
        sa.Column("credential_key", sa.String(length=100), nullable=True, comment="凭证引用Key (指向Vault或Env Var)"),
    )
    op.add_column(
        "mdm_systems_registry",
        sa.Column("plugin_config", sa.JSON(), nullable=True, comment="插件特定配置 (JSON, 如过滤规则、超时设置)"),
    )
    op.add_column(
        "mdm_systems_registry",
        sa.Column("enabled_plugins", sa.String(length=255), nullable=True, comment="启用的采集插件列表 (逗号分隔)"),
    )
    op.add_column(
        "mdm_systems_registry",
        sa.Column("last_sync_at", sa.DateTime(timezone=True), nullable=True, comment="最后一次数据同步时间"),
    )
    ...
    op.alter_column("satisfaction_records", "date", existing_type=sa.DATE(), comment="调查日期", existing_nullable=True)
    op.alter_column(
        "satisfaction_records",
        "tags",
        existing_type=sa.VARCHAR(length=255),
    ...
    op.alter_column("sys_sync_logs", "message", existing_type=sa.TEXT(), comment="同步结果信息", existing_nullable=True)
    op.alter_column(
        "sys_team_members",
        "id",
        existing_type=sa.INTEGER(),
    ...
    op.alter_column("sys_user_roles", "user_id", existing_type=sa.UUID(), comment="用户ID", existing_nullable=False)
    op.alter_column("sys_user_roles", "role_id", existing_type=sa.INTEGER(), comment="角色ID", existing_nullable=False)
...
def downgrade() -> None:
    ...
    op.alter_column("mdm_entity_topology", "sync_version", existing_type=sa.INTEGER(), nullable=True)
    op.alter_column(
        "mdm_entity_topology",
        "meta_info",
        existing_type=postgresql.JSON(astext_type=sa.Text()),
