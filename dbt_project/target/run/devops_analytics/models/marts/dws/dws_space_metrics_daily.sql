  ...
  create  table "devops_db"."public_marts"."dws_space_metrics_daily__dbt_tmp"
...
satisfaction as (
    ...
    from "devops_db"."public"."satisfaction_records" s
    join "devops_db"."public_staging"."stg_mdm_identities" u on s.user_email = u.email
    group by 1, 2
),
