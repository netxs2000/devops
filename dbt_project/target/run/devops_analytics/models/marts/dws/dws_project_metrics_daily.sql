  ...
  create  table "devops_db"."public_marts"."dws_project_metrics_daily__dbt_tmp"
...
calendar as (
    ...
    from "devops_db"."public_intermediate"."int_unified_activities"
),

projects as (
    select gitlab_project_id as project_id from "devops_db"."public_staging"."stg_gitlab_projects"
),
...
mr_stats as (
    ...
    from "devops_db"."public_staging"."stg_gitlab_merge_requests"
    group by 1, 2
),
