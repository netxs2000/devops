  ...
  create view "devops_db"."public_intermediate"."int_activity_financial_classification__dbt_tmp"
...
with activities as (
    select * from "devops_db"."public_intermediate"."int_unified_activities"
),
