  ...
  create view "devops_db"."public_intermediate"."int_unified_work_items__dbt_tmp"
...
jira_items as (
    ...
    from "devops_db"."public"."jira_issues"
),
...
gitlab_items as (
    ...
    from "devops_db"."public_staging"."stg_gitlab_issues"
)
