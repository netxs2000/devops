...
direct_pushes as (
    ...
    left join {{ ref('stg_gitlab_merge_requests') }} mr on c.commit_sha = mr.merge_commit_sha
...
join {{ ref('stg_gitlab_merge_requests') }} mr on p.gitlab_project_id = mr.project_id
