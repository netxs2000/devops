...
COST_CODE_STRUCTURE = [
    {
        ...
        "name": "人力成本 (Labor)",
        "category": "Labor",
        "description": "包含内部员工与外包人员的工资及福利支付。",
        "children": [
            {"code": "1001.01", "name": "核心研发人工 (Internal)", "category": "Labor", "capex_opex": "CAPEX"},
            {"code": "1001.02", "name": "日常运维人工 (Ops)", "category": "Labor", "capex_opex": "OPEX"},
            {"code": "1001.03", "name": "研发外包费 (Outsourced)", "category": "Labor", "capex_opex": "OPEX"}
        ]
    },
    {
        "code": "1002",
        ...
        "description": "涵盖云厂商账单、机房租赁及网络带宽费用。",
        "children": [
            {"code": "1002.01", "name": "云计算节点 (EC2/CVM)", "category": "Cloud", "capex_opex": "OPEX"},
            {"code": "1002.02", "name": "数据库与存储记录 (DB/OSS)", "category": "Cloud", "capex_opex": "OPEX"},
            {"code": "1002.03", "name": "安全与CDN加速", "category": "Cloud", "capex_opex": "OPEX"}
        ]
    },
    {
        "code": "2001",
        "name": "软件资产与授权 (License)",
        "category": "License",
        "description": "开发工具、质量门禁工具及中间件授权。",
        "children": [
            {"code": "2001.01", "name": "DevOps 工具链授权 (Jira/Sonar)", "category": "License", "capex_opex": "OPEX"},
            {"code": "2001.02", "name": "第三方库/专利费", "category": "License", "capex_opex": "CAPEX"}
        ]
    }
]
