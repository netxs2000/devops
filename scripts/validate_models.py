...
def run_validation():
    ...
    models_to_validate = [
        ...
        },
        {
            ...
            "expectations": [
                ...
                {"type": "expect_column_values_to_not_be_null", "column": "quality_gate"},
                {
                    ...
                    "column": "quality_gate",
                    "value_set": ["OK", "ERROR", "WARN", "UNKNOWN"],
                },
            ],
        },
        {
            ...
            "expectations": [
                ...
                },
                {
                    ...
                    "value_set": ["NON_COMPLIANT", "PROCESS_RISK", "COMPLIANT"],
                },
            ],
        },
        {
        ...
        },
        {
            ...
            "expectations": [{"type": "expect_column_values_to_not_be_null", "column": "project_name"}],
        },
        {
        ...
        },
        {
            ...
            "expectations": [{"type": "expect_column_values_to_not_be_null", "column": "unified_id"}],
        },
    ]
    all_passed = True
    results_summary = []
