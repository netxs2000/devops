...
from devops_collector.models import Base, Organization, Product, ProjectMaster, ProjectProductRelation, User, EntityTopology, SystemRegistry
    ...
    with open(PROJ_CSV, mode='r', encoding='utf-8-sig') as f:
        ...
        for row in reader:
            ...
            if repo_url:
                ...
                if not project.description: project.description = ""
            ...
            if target_prod_id:
                ...
                if not rel and project.org_id:
                    session.add(ProjectProductRelation(project_id=proj_id, product_id=target_prod_id, org_id=project.org_id, relation_type='PRIMARY'))
    session.commit()
